...
class sistema():
    ...
    def validar (self, cedula):
        return cedula not in self.__listaPacientes # validar si la cedula ya existe , sino existe error
    ...
    def agregarPaciente(self,nombre,cedula,droga):
        ...
        self.__listaPacientes[cedula] = p # crea un diccionario con la infromacion de la lista de pacientes
